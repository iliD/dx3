...
export default function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100">
      <div className="flex flex-col items-center text-center font-mono" style={{ paddingTop: '200px', gap: '18px' }}>
        <motion.div
          style={{
        ...
        <div style={{ fontSize: '16px', fontWeight: 300 }}>designDesignsDesign</div>
      </div>
    </div>
  );
}
